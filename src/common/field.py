...
class StringField(Field):
    def __init__(
        ...
        label=None,
        validators=None,
        empty_to_default=True,
        strip=True,
        words_filter=None,
        no_exist_to_default=True,
        **kwargs
    ):
        ...
        self.no_exist_to_default = no_exist_to_default
    ...
    def process_formdata(self, values):
        if values:
            ...
            if value == "":
                ...
                try:
                    self.data = datetime.strptime(value, self.format).time()
                except ValueError:
                    self.data = None
                    raise ValueError("invalid datetime: '{}'".format(values[0]))
        else:
    ...
    def process_formdata(self, values):
        if values:
            ...
            if value == "":
                ...
                value = [v.strip() for v in re.split(r"[{}]".format(self.sep), value)]
